...
export default function DashboardRiwayatScreen() {
  ...
  const renderDashboard = () => (
    <ScrollView style={styles.contentScroll} contentContainerStyle={{ padding: 16 }}>
      ...
      <View style={styles.row}>
        <View style={[styles.card, { borderColor: "#11cccc", flex: 1, marginRight: 8 }]}>
          <Text style={[styles.sectionTitle, { color: "#f9d71c" }]}>
        ...
        <View style={[styles.card, { borderColor: "#11cccc", flex: 1, marginLeft: 8 }]}>
          <Text style={[styles.sectionTitle, { color: "#f9d71c" }]}>Mode Otomatis</Text>
  ...
  const renderRiwayat = () => (
    <ScrollView style={styles.contentScroll} contentContainerStyle={{ paddingBottom: 32 }}>
      ...
      <View style={[styles.logBox, { borderColor: "#39b54a" }]}>
        ...
        <View style={styles.statusRow}>
          <Text style={{ color: "#39b54a", fontWeight: "bold" }}>Status Koneksi :</Text>
      ...
      <View style={[styles.accountBox, { borderColor: "#00b2fe" }]}>
        ...
        <View style={styles.accountInfoRow}>
          ...
          <Text style={styles.accountValue}>: Icam</Text>
        </View>
        <View style={styles.accountInfoRow}>
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          style={activeTab === "dashboard" ? styles.navItemSelected : styles.navItem}
          onPress={() => setActiveTab("dashboard")}
        >
          <Text style={activeTab === "dashboard" ? styles.navIconSelected : styles.navIcon}>🏠</Text>
          <Text style={activeTab === "dashboard" ? styles.navTextSelected : styles.navText}>Dashboard</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={activeTab === "riwayat" ? styles.navItemSelected : styles.navItem}
          onPress={() => setActiveTab("riwayat")}
        >
          <Text style={activeTab === "riwayat" ? styles.navIconSelected : styles.navIcon}>📜</Text>
          <Text style={activeTab === "riwayat" ? styles.navTextSelected : styles.navText}>Riwayat</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
